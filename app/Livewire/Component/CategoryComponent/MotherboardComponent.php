...
class MotherboardComponent extends Component
{
    ...
    #[Validate('required', message: 'Please provide motherboard maximum memory')]
    public $max_mem;

    #[Validate('required', message: 'Please provide PCIE generation')]
    public $mb_pcgen;
    ...
    public function submit()
    {
        ...
        if ($validator) {
            ...
            $motherboard = Motherboard::create([
                ...
                'price' => $validator['price'],
                'socket' => $validator['mb_socket'],
                'form_factor' => $validator['mb_form'],
                'memory_slots' => $validator['mb_slot'],
                'max_memory' => $validator['max_mem'],
                'pcie_gen' => $validator['mb_pcgen'],
                'description' => $validator['productDescription'],
                'condition' => $validator['productCondition'],
            ]);

            // dd($motherboard, $product);
