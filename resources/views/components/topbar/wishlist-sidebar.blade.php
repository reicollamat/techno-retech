<div >
    ...
    <button class="btn outline-remove position-relative" type="button" data-bs-toggle="offcanvas"
        ...
        <span
            class="position-absolute top-0 start-100 translate-middle badge bg-transparent  text-black">
    ...
    <div class="offcanvas offcanvas-end min-w-[500px]" data-bs-scroll="false" tabindex="-1"
        ...
        <div class="offcanvas-body my-0 py-2 px-1.5 bg-secondary-subtle">
            <div>
                <livewire:wishlist.wish-list/>
            </div>
        </div>
    </div>
</div>
