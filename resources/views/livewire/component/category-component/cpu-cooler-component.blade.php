                ...
                <div>
                    ...
                    <div class="mb-4">
                        <label for="cooler_type"
                            class="block mb-1 text-sm font-medium text-gray-800 dark:text-white pl-1">Cooler
                            Type</label>
                    ...
                    <!-- Noise Level (db) -->
                    <div class="mb-4">
                        <label for="cpuc_noise"
                            class="block mb-1 text-sm font-medium text-gray-800 dark:text-white  pl-1">Noise Level
                            (db)</label>
                        <input type="text" id="cpuc_noise" wire:model.blur="cpuc_noise"
                            class="bg-white border border-gray-300 text-gray-900 text-sm !rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="29 db" required>
                        @error('cpuc_noise')
                        <span class="font-sm text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
