        ...
        <div class="mb-4 p-4 bg-white border border-gray-200 rounded-lg">
            <div class="grid md:grid-cols-2 gap-4">
                <div>
                    ...
                    <div class="mb-4">
                        <label for="gpu_vram"
                            class="block mb-1 text-sm font-medium text-gray-800 dark:text-white pl-1">VRAM
                            (GB)</label>
                    ...
                    <div class="mb-4">
                        <label for="gpu_size"
                            class="block mb-1 text-sm font-medium text-gray-800 dark:text-white pl-1">GPU
