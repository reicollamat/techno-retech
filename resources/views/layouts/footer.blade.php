    ...
    <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="lg:flex lg:items-start lg:gap-8">
            <div class="text-teal-600">
                ...
                <img src="{{ asset('/img/brand/svg/logo.svg') }}" class="h-10 w-10" alt="">
            </div>
            ...
            <div class="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                <div class="col-span-2">
                    <div>
                        ...
                        <p class="mt-4 text-gray-500">
                            PR-TECH where we value our customers, offers the best products and services.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-span-2 sm:col-span-1">
                    ...
                    <ul class="mt-6 space-y-4 text-sm">
                        <li>
                            <a href="{{ route('about-us') }}" class="text-gray-700 transition hover:opacity-75">
                                About
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('support-center') }}" class="text-gray-700 transition hover:opacity-75">
                                Support Center
                            </a>
                        </li>
                    </ul>
                ...
                <div class="col-span-2 sm:col-span-1">
                    ...
                    <ul class="mt-6 space-y-4 text-sm">
                        <li>
                            <a href="{{ route('contact-us') }}" class="text-gray-700 transition hover:opacity-75">
                                Contact
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('help') }}" class="text-gray-700 transition hover:opacity-75">
                                FAQs
                            </a>
                        </li>
        ...
        <div class="mt-8 border-t border-gray-100 pt-8">
            <div class="sm:flex sm:justify-between">
                <p class="text-xs text-gray-500">
                    &copy; 2022. PR-TECH. All rights reserved.
                </p>
