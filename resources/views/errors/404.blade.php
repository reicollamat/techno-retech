    ...
    <div class="h-screen w-screen bg-gray-100 flex items-center">
        <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
            <div class="max-w-md">
                ...
                <p class="text-3xl py-2 md:text-3xl font-light leading-normal">Sorry we couldn't find this page. </p>
                <p class="mb-4">Click the Button Below and Continue Shoppping with Us!</p>
                ...
                {{--     Take me Home. --}}
                {{-- </a> --}}
                <a class="flex w-full no-underline decoration-0 text-black" href="{{ route('index_landing') }}">
                    <span
                        class="lg:!h-12 w-fit h-10 flex items-center justify-center uppercase font-semibold px-4 lg:!px-6 border border-black hover:bg-gray-800 hover:text-white transition duration-500 ease-in-out">
                        <span>
                            Take me Home.
                        </span>
                    </span>
